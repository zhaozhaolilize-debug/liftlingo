...
const EXERCISE_DB = {
  pull: [
    ...
    { id:"p7", emoji:"🪢", en:"Cable Face Pull", zh:"绳索面拉", muscle_en:"Rear Delts / Upper Back", muscle_zh:"三角肌后束 / 上背", sets:3, reps:15, rest:45, douyinUrl:"https://www.douyin.com",
    ...
    { id:"p8", emoji:"🤚", en:"Single-Arm Lat Pulldown", zh:"单臂高位下拉", muscle_en:"Lats (Unilateral)", muscle_zh:"背阔肌 / 单侧", sets:3, reps:12, rest:60, douyinUrl:"https://www.douyin.com",
      tip_en:"Pull the handle down to your ribs one arm at a time, let the lat stretch fully on the return.", tip_zh:"单臂将把柄拉向肋部，还原时让背阔肌充分伸展。",
      videoUrl:"",
      cues:["Brace your core","Pull elbow down and back","Squeeze the lat at the bottom","Full stretch on return"],
      alts:A([{en:"Single-Arm Band Pulldown",zh:"弹力带单臂下拉",why_en:"No cable machine needed",why_zh:"无需绳索器械"},{en:"Lat Pulldown (two-arm)",zh:"双臂高位下拉",why_en:"Easier to balance the load",why_zh:"双臂更易控制负荷"},{en:"One-Arm Dumbbell Row",zh:"单臂哑铃划船",why_en:"Same unilateral lat focus",why_zh:"同样单侧背阔肌训练"}]) },
    { id:"p9", emoji:"🚣", en:"Seated Row (Machine)", zh:"坐姿划船（器械）", muscle_en:"Upper Back / Lats", muscle_zh:"上背 / 背阔肌", sets:3, reps:12, rest:60, douyinUrl:"https://www.douyin.com",
      tip_en:"Chest against the pad, drive elbows straight back, squeeze your shoulder blades together.", tip_zh:"胸部贴靠靠垫，肘部向后直线发力，夹紧肩胛骨。",
      videoUrl:"",
      cues:["Chest stays on the pad","Drive elbows straight back","Squeeze shoulder blades","Control the release"],
      alts:A([{en:"Seated Cable Row",zh:"坐姿绳索划船",why_en:"No machine needed",why_zh:"无需固定器械"},{en:"Dumbbell Row",zh:"哑铃单臂划船",why_en:"Single arm, easier balance",why_zh:"单臂操作更易平衡"},{en:"Resistance Band Row",zh:"弹力带划船",why_en:"Home-friendly option",why_zh:"居家即可完成"}]) },
    { id:"p10", emoji:"🙏", en:"Lat Prayer", zh:"背阔肌祈祷式", muscle_en:"Lats (Isolation)", muscle_zh:"背阔肌 / 孤立", sets:3, reps:12, rest:45, douyinUrl:"https://www.douyin.com",
      tip_en:"Kneel facing the cable, arms straight, press down and back in an arc like a prayer motion.", tip_zh:"跪姿面对绳索器械，手臂伸直，呈祈祷弧线向下后方压。",
      videoUrl:"",
      cues:["Arms stay straight","Hinge slightly from the hips","Press down in an arc","Squeeze the lats at the bottom"],
      alts:A([{en:"Straight-Arm Pulldown",zh:"直臂下压",why_en:"Standing version, same motion",why_zh:"站姿版本动作相同"},{en:"Band Lat Pulldown",zh:"弹力带下拉",why_en:"No cable machine needed",why_zh:"无需绳索器械"},{en:"Superman Hold",zh:"超人伸展",why_en:"Bodyweight lat activation",why_zh:"自重激活背阔肌"}]) },
    { id:"p11", emoji:"🏋️", en:"Barbell Row", zh:"杠铃划船", muscle_en:"Upper Back / Lats", muscle_zh:"上背 / 背阔肌", sets:4, reps:10, rest:90, douyinUrl:"https://www.douyin.com",
      tip_en:"Hinge at the hips to about 45°, keep a flat back, pull the bar to your lower ribs.", tip_zh:"髋部铰链前倾约45度，保持背部平直，将杠铃拉向下肋部。",
      videoUrl:"",
      cues:["Flat back, chest up","Hinge to 45 degrees","Pull bar to your ribs","Lower with control"],
      alts:A([{en:"Dumbbell Row",zh:"哑铃划船",why_en:"Easier to learn the pattern",why_zh:"更易掌握动作模式"},{en:"Seated Cable Row",zh:"坐姿绳索划船",why_en:"Less lower-back demand",why_zh:"对下背要求更低"},{en:"Inverted Row",zh:"澳式引体",why_en:"Bodyweight, beginner friendly",why_zh:"自重训练新手友好"}]) },
    { id:"p12", emoji:"💪", en:"One-Arm Dumbbell Row", zh:"单臂哑铃划船", muscle_en:"Lats (Unilateral)", muscle_zh:"背阔肌 / 单侧", sets:3, reps:12, rest:60, douyinUrl:"https://www.douyin.com",
      tip_en:"Brace your free hand on a bench, pull the dumbbell to your hip, keep hips square.", tip_zh:"空闲手撑稳长椅，将哑铃拉向髋部，保持髋部水平不转动。",
      videoUrl:"",
      cues:["Brace on the bench","Pull elbow to your hip","Keep hips square","Squeeze at the top"],
      alts:A([{en:"Single-Arm Lat Pulldown",zh:"单臂高位下拉",why_en:"No dumbbell needed",why_zh:"无需哑铃"},{en:"Resistance Band Row",zh:"弹力带划船",why_en:"Home-friendly option",why_zh:"居家即可完成"},{en:"Renegade Row",zh:"俯撑哑铃划船",why_en:"Adds core stability work",why_zh:"同时锻炼核心稳定"}]) },
    { id:"p13", emoji:"🪑", en:"Preacher Curl", zh:"牧师凳弯举", muscle_en:"Biceps (Isolation)", muscle_zh:"二头肌 / 孤立", sets:3, reps:12, rest:45, douyinUrl:"https://www.douyin.com",
      tip_en:"Rest your upper arms flat on the pad, curl up without lifting your elbows, lower slowly.", tip_zh:"上臂贴平牧师凳，弯举时肘部不离开靠垫，缓慢下放。",
      videoUrl:"",
      cues:["Upper arms flat on the pad","Curl without lifting elbows","Squeeze at the top","Lower slowly"],
      alts:A([{en:"Bicep Curl",zh:"弯举",why_en:"No bench needed",why_zh:"无需器械凳"},{en:"Hammer Curl",zh:"锤式弯举",why_en:"Easier on the wrists",why_zh:"对手腕更友好"},{en:"Band Curl",zh:"弹力带弯举",why_en:"Home-friendly option",why_zh:"居家即可完成"}]) },
  ],
  push: [
